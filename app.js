...
switch (true) {
    ...
    break    
    case isMedium(aqiValue): {body.style.background='yellow'}
    break    
    case isUnhealthyForSensitive(aqiValue): {body.style.background=''}   
    break    
    case isUnhealthy(aqiValue): {body.style.background=''}   
    break    
